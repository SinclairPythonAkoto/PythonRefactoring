...
# 3. Write a Python program to create an instance of a specified class and display the namespace of the
# said instance.
# 4. 'builtins' module provides direct access to all 'built-in' identifiers of Python. Write a python
# program which import the abs() function using the builtins module, display the documentation of abs()
# function and find the absolute value of -155.
# 5. Define a Python function student(). Using function attributes display the names of all arguments.
# 6. Write a Python function student_data () which will print the id of a student (student_id). If the
# user passes an argument student_name or student_class the function will print the student name and class.
...
# 8. Write a Python program to crate two empty classes, Student and Marks. Now create some instances
...
# 9. Write a Python class named Student with two attributes student_name, marks. Modify the attribute
# values of the said class and print the original and modified values of the said attributes.
# 10. Write a Python class named Student with two attributes student_id, student_name. Add a new
# attribute student_class and display the entire attribute and their values of the said class.
# Now remove the student_name attribute and display the entire attribute with values.
# 11. Write a Python class named Student with two attributes student_id, student_name. Add a new
# attribute student_class. Create a function to display the entire attribute and their values
# in Student class.
# 12. Write a Python class named Student with two instances student1, student2 and assign given
...
# 15. Write a Python class to find validity of a string of parentheses, '(', ')', '{', '}', '[' and '].
...
# 17. Write a Python class to find a pair of elements (indices of the two numbers) from a given array
...
# 21. Write a Python class which has two methods get_String and print_String. get_String accept a
# string from the user and print_String print the string in upper case.
# 22. Write a Python class named Rectangle constructed by a length and width and a method which will
# compute the area of a rectangle.
# 23. Write a Python class named Circle constructed by a radius and two methods which will compute
